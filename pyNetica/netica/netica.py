...
if 'window' in platform.system().lower():
    ...
    NETICA_LIB = os.path.join(os.path.split(__file__)[0], 'netica-lib', 'Netica.dll')
else:
    from ctypes import cdll
    NETICA_LIB = os.path.join(os.path.split(__file__)[0], 'netica-lib', 'libnetica.so')
...
#        self.ln = cdll.LoadLibrary("/Users/heijer/Downloads/Netica_API_504/lib/libnetica.so")
    ...
    def newenv(self, lic=None):
        ...
        return self.ln.NewNeticaEnviron_ns(lic, None, None) # env_p
